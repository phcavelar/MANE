...
def get_parser():
    ...
    parser.add_argument('--dataset', nargs='?', default='Youtube/',
                        help='Input graph path ')
    ...
    parser.add_argument('-allp','--att_link_label_path', nargs='?', default='data/labels/link/',
                        help='For semi-supervised attention model (link prediction), specifies train indices, label path.')

    parser.add_argument('--nreps', type=int, default=8,
                        help='For semi-supervised attention model, specifies number of folds. Default is 8')
    ...
    parser.add_argument('--gamma', type=float, default=1000,
                        help='Attention hyperparameter. Default is 1000 (for link-prediction).')
